...
def add_logo(input, logo_path, output, corner ='bottom-right', padding = 15):
    ...
    # to create an output folder if it doesn't exist
    ...
    for filename in os.listdir(input):
        if filename.lower().endswith(('png', 'jpg', 'jpeg')):
            ...
            scale_ratio = (img_w * 0.05) / logo.size[0]
...
# call the function
add_logo('Logo_Stamp/Photo_folder', 'Logo_Stamp/logo.png', 'Logo_Stamp/Stamped_photos')